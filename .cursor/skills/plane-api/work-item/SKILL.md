---
name: work-item
description: Work items are the fundamental unit of work in Plane. They represent tasks that need to be accomplished — assignable, trackable, and actionable to-dos in your project management workflow.
---

## The Work Item object [​](https://developers.plane.so/api-reference/issue/overview\#the-work-item-object)

### Attributes [​](https://developers.plane.so/api-reference/issue/overview\#attributes)
